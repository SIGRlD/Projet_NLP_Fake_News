...
# dataset = pd.read_csv("predictions_test.csv")
#
# scores = np.array(dataset['score_true'])
#
# plt.hist(scores, bins=30)
# plt.title("Distribution des scores pour 'true' sur dev")
# plt.xlabel("Score (proba d'être true)")
...
trainer.train()
model.save_pretrained("./bert_model_true/")
tokenizer.save_pretrained("./bert_model_true/")
