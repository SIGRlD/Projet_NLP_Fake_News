...
classifieur = classifier_models(embedding.X, y_train_true, rebalance=True)
...
df_train.to_csv("train_scores.csv", index=False)
...
df_test.to_csv("test_scores.csv", index=False)
