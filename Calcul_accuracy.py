...
dataset_train = pd.read_csv("predictions/predictions_train_other.csv")
pred_train = np.array(dataset_train['pred_other'])

dataset_dev = pd.read_csv("predictions/predictions_dev_other.csv")
pred_dev = np.array(dataset_dev['pred_other'])

dataset_test = pd.read_csv("predictions/predictions_test_other.csv")
pred_test = np.array(dataset_test['pred_other'])
